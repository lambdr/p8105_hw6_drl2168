...
I think the warning given here is due to collinearity between some terms (in particular `ppwt` with `delwt` and `ppbmi`. I do not know whether these terms capture variation that is particularly relevant to the prediction of birthweight, so I will keep them in.
