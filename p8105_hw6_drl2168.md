...
```
    ...
    ##   <chr>          <dbl>     <dbl>     <dbl>     <dbl>
    ## 1 (Intercept)  7.78      0.235       33.1  1.54e-111
    ## 2 tmin         1.02      0.0166      61.4  1.95e-193
    ## 3 prcp         0.00444   0.00217      2.05 4.11e-  2
...
Here is the code for doing stepwise selection:
