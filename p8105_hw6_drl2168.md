...
```
    ...
    ##   <chr>            <dbl>     <dbl>     <dbl>     <dbl>
    ## 1 (Intercept) 7.74         0.220    35.1     1.25e-118
    ## 2 tmin        1.02         0.0155   65.9     1.34e-203
    ## 3 prcp        0.00000222   0.00201   0.00111 9.99e-  1
...
(in particular `ppwt` with `delwt` and `ppbmi`. I do not know whether
these terms capture variation that is particularly relevant to the
prediction of birthweight, so I will keep them in.
